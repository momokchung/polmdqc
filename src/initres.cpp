///////////////////////////////////////////////////////
//                                                   //
//  initres.cpp  --  setup biopolymer residue names  //
//                                                   //
///////////////////////////////////////////////////////
...
void initres()
{
    // supported amino acid 1-letter and 3-letter codes
    std::string acid1[maxamino] = { 
        "G", "A", "V", "L", "I", "S", "T", "C", "C", "c",
        "P", "F", "Y", "y", "W", "H", "U", "Z", "D", "d",
        "N", "E", "e", "Q", "M", "K", "k", "R", "O", "B",
        "J", "t", "f", "a", "x", "n", "m", "X" 
    };
    std::string acid3[maxamino] = {
    ...
    // supported nucleotide 1-letter and 3-letter codes
    std::string base1[maxnuc] = {
        "A", "G", "C", "U", "D", "B", "I", "T", "1", "2",
        "3", "X"
    };
    std::string base3[maxnuc] = {
        "  A", "  G", "  C", "  U", " DA", " DG", " DC",
        " DT", " MP", " DP", " TP", "UNK"
    };
    ...
    int nn[maxamino] = {
        403, 409, 415, 421, 427, 433, 439, 445, 451, 457,
    ...
    int o5t[maxnuc] = {
        1001, 1031, 1062, 1090, 1117, 1146, 1176, 1203,
           0,    0,    0,    0
    };
    int c5t[maxnuc] = {
        1002, 1032, 1063, 1091, 1118, 1147, 1177, 1204,
           0,    0,    0,    0
    };
    int h51t[maxnuc] = {
        1003, 1033, 1064, 1092, 1119, 1148, 1178, 1205,
           0,    0,    0,    0
    };
    int h52t[maxnuc] = {
        1004, 1034, 1065, 1093, 1120, 1149, 1179, 1206,
           0,    0,    0,    0
    };
    int c4t[maxnuc] = {
        1005, 1035, 1066, 1094, 1121, 1150, 1180, 1207,
           0,    0,    0,    0
    };
    int h4t[maxnuc] = {
        1006, 1036, 1067, 1095, 1122, 1151, 1181, 1208,
           0,    0,    0,    0
    };
    int o4t[maxnuc] = {
        1007, 1037, 1068, 1096, 1123, 1152, 1182, 1209,
           0,    0,    0,    0
    };
    int c1t[maxnuc] = {
        1008, 1038, 1069, 1097, 1124, 1153, 1183, 1210,
           0,    0,    0,    0
    };
    int h1t[maxnuc] = {
        1009, 1039, 1070, 1098, 1125, 1154, 1184, 1211,
           0,    0,    0,    0
    };
    int c3t[maxnuc] = {
        1010, 1040, 1071, 1099, 1126, 1155, 1185, 1212,
           0,    0,    0,    0
    };
    int h3t[maxnuc] = {
        1011, 1041, 1072, 1100, 1127, 1156, 1186, 1213,
           0,    0,    0,    0
    };
    int c2t[maxnuc] = {
        1012, 1042, 1073, 1101, 1128, 1157, 1187, 1214,
           0,    0,    0,    0
    };
    int h21t[maxnuc] = {
        1013, 1043, 1074, 1102, 1129, 1158, 1188, 1215,
           0,    0,    0,    0
    };
    int o2t[maxnuc] = {
        1014, 1044, 1075, 1103,    0,    0,    0,    0,
           0,    0,    0,    0
    };
    int h22t[maxnuc] = {
        1015, 1045, 1076, 1104, 1130, 1159, 1189, 1216,
           0,    0,    0,    0
    };
    int o3t[maxnuc] = {
        1016, 1046, 1077, 1105, 1131, 1160, 1190, 1217,
           0,    0,    0,    0
    };
    int pt[maxnuc] = {
    ...
    int opt[maxnuc] = {
        1231, 1231, 1231, 1231, 1243, 1243, 1243, 1243,
           0,    0,    0,    0
    };
    int h5tt[maxnuc] = {
        1233, 1233, 1233, 1233, 1245, 1245, 1245, 1245,
           0,    0,    0,    0
    };
    int h3tt[maxnuc] = {
        1238, 1238, 1238, 1238, 1250, 1250, 1250, 1250,
           0,    0,    0,    0
    };

    // set amino acid names and peptide backbone biotypes
    for (int i = 0; i < maxamino; i++) {
        amino[i] = acid3[i];
        amino1[i] = acid1[i];
        ntyp[i] = nt[i];
        catyp[i] = cat[i];
    ...
    // set values for the 1- and 3-letter nucleotide names
    for (int i = 0; i <  maxnuc; i++) {
        nuclz[i] = base3[i];
        nuclz1[i] = base1[i];
        o5typ[i] = o5t[i];
        c5typ[i] = c5t[i];
