...
///////////////////////////////////////////////////////////
//                                                       //
//  alf_tetra  --  computes radius of orthogonal sphere  //
//                                                       //
///////////////////////////////////////////////////////////
...
void Alfcx::alf_tetra(real* a, real* b, real* c, real* d,
...
/////////////////////////////////////////////////////////////////
//                                                             //
//  alf_trig  --  checks if triangle belongs to alpha complex  //
//                                                             //
/////////////////////////////////////////////////////////////////

// "alf_trig" checks if a triangle ABC belons to the alpha complex

void Alfcx::alf_trig(real* a, real* b, real* c, real* d, real* e,
...
////////////////////////////////////////////////////////////
//                                                        //
//  alf_edge  --  check if edge belongs to alpha complex  //
//                                                        //
////////////////////////////////////////////////////////////

// "alf_edge" checks if the edge belongs to the alpha complex

void Alfcx::alf_edge(std::vector<Vertex>& vertices, real* a, real* b, real ra, real rb,
...
inline void Alfcx::edge_radius(real* a, real* b, real ra, real rb,
...
inline void Alfcx::edge_attach(real* a, real* b, real* c, real ra, real rb,
...
inline void Alfcx::triangle_attach(real* a, real* b, real* c, real* d,
...
inline void Alfcx::triangle_radius(real* a, real* b, real* c, real ra, real rb,
...
inline void Alfcx::vertex_attach(real* a, real* b, real ra, real rb, int& testa, int& testb)
{
    real Dab[3];
    ...
    real dist2 = Dab[0] *Dab[0] + Dab[1]*Dab[1] + Dab[2]*Dab[2];

    real test1 = dist2 + ra2 - rb2;
    real test2 = dist2 - ra2 + rb2;
...
inline void Alfcx::get_coord2(std::vector<Vertex>& vertices, int ia, int ja, real* a, real* b, real* cg, real& ra, real& rb)
{
    real x;
...
// containing all atoms of the protein, centers them on (0,0,0),
// recomputes their weights and stores them in local arrays
inline void Alfcx::get_coord4(std::vector<Vertex>& vertices, int ia, int ja, int ka, int la, real* a, real* b,
