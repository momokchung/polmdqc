...
// "delaunay" computes the weighted Delaunay triangulation
...
/////////////////////////////////////////////////////////
//                                                     //
//  locatejw  --  locate tetrahedron to add new point  //
//                                                     //
/////////////////////////////////////////////////////////

// "locatejw" uses the "jump-and-walk" technique: first N active
...
/////////////////////////////////////////////////////////
//                                                     //
//  insidetetra  --  tests if point is in tetrahedron  //
//                                                     //
/////////////////////////////////////////////////////////

// "insidetetra" tests if a point p is inside a tetrahedron
...
inline void insidetetra(int p, int a, int b, int c, int d, int iorient, bool& is_in, bool& redundant, int& ifail)
{
    ...
    if (ninf == 0)
    {
        ...
        test_pijk = (REAL_ABS(det_pijk) > deleps);
        ...
        test_pjil = (REAL_ABS(det_pjil) > deleps);
        ...
        test_pkjl = (REAL_ABS(det_pkjl) > deleps);
        ...
        test_pikl = (REAL_ABS(det_pikl) > deleps);
...
////////////////////////////////////////////////////////
//                                                    //
//  reordertetra  --  reorder vertices of tetrahedra  //
//                                                    //
////////////////////////////////////////////////////////

// "reordertetra" reorders the vertices of a list of tetrahedron,
...
/////////////////////////////////////////////////////////////
//                                                         //
//  removeinf  --  remove vertices of infinite tetrahedra  //
//                                                         //
/////////////////////////////////////////////////////////////

// "removeinf" sets to 0 the status of tetrahedron
...
real tetravol(real* a, real* b, real* c, real* d);
...
inline void peel(int& flag)
{
    ...
    for (int i = 0; i < ntetra; i++) {
        ...
        real vol = tetravol(coorda, coordb, coordc, coordd);
...
inline real tetravol(real* a, real* b, real* c, real* d)
{
    real vol;
    real ad[3], bd[3], cd[3];
    real Sbcd[3];
