...
///////////////////////////////////////////////
//                                           //
//  delcx  --  Delaunay triangulation class  //
//                                           //
///////////////////////////////////////////////

// "delcx" class computes the Delaunay triangulation

//////////////////////////////////////////////////////////
//                                                      //
//  init  --  initialize/set up Delaunay triangulation  //
//                                                      //
//////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////
//                                                     //
//  regular3D  --  weighted 3D Delaunay triangulation  //
//                                                     //
/////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////
//                                                      //
//  locate_jw  --  locate tetrahedron to add new point  //
//                                                      //
//////////////////////////////////////////////////////////
...
void Delcx::flip(std::vector<Vertex>& vertices, std::vector<Tetrahedron>& tetra)
{
    ...
    while (!link_facet.empty()) {
        ...
        if (iflip==1) {
            ...
            printf("\n DELCX::FLIP  --  Three Edges Flippable\n");
            fatal();
        }
    }
...
//////////////////////////////////////////////////////////
//                                                      //
//  inside_tetra  --  tests if point is in tetrahedron  //
//                                                      //
//////////////////////////////////////////////////////////
...
void Delcx::inside_tetra(std::vector<Vertex>& vertices, int p, int a, int b, int c, int d, int iorient, bool& is_in, bool& redundant, int& ifail)
{
    ...
    real ra,rb,rc,rd,re;
    real Sij_1,Sij_2,Sij_3,Skl_1,Skl_2,Skl_3;
    real det_pijk,det_pjil,det_pkjl,det_pikl,det_pijkl;
    ...
    if (ninf == 0)
    {
        ...
        test_pijk = (REAL_ABS(det_pijk) > eps);
        ...
        test_pjil = (REAL_ABS(det_pjil) > eps);
        ...
        test_pkjl = (REAL_ABS(det_pkjl) > eps);
        ...
        test_pikl = (REAL_ABS(det_pikl) > eps);
    ...
    bool& regular, bool& convex, bool& test_abpo, bool& test_bcpo, bool& test_capo)
{
    ...
    real det_abpo,det_bcpo,det_capo,det_abcpo,det_abpc;
    real xa,ya,xb,yb,xc,yc;
    real ra,rb,rc,rd,re;
    real a_p[4],b_p[4],c_p[4],o_p[4];
    real i_p[3],j_p[3];
    real Mbo[3],Mca[3],Mjo[3],Mio[3];
...
/////////////////////////////////////////////////////////
//                                                     //
//  reorder_tetra  --  reorder vertices of tetrahedra  //
//                                                     //
/////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////
//                                                          //
//  remove_inf  --  remove vertices of infinite tetrahedra  //
//                                                          //
//////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////
//                                                //
//  peel  --  remove flat tetrahedra at boundary  //
//                                                //
////////////////////////////////////////////////////
...
void Delcx::peel(std::vector<Vertex>& vertices, std::vector<Tetrahedron>& tetra, int& flag)
{
    ...
    int res;
    int ntetra = tetra.size();
    real coorda[3], coordb[3], coordc[3], coordd[3];
    ...
    for (int i = 0; i < ntetra; i++) {
        ...
        real vol = tetra_vol(coorda, coordb, coordc, coordd);
...
inline real Delcx::tetra_vol(real* a, real* b, real* c, real* d)
{
    real vol;
    real ad[3], bd[3], cd[3];
    real Sbcd[3];
...
//////////////////////////////////////
//                                  //
//  addBogus  --  add bogus points  //
//                                  //
//////////////////////////////////////

// "addBogus" adds bogus points so that nvertices >= 4

void Delcx::addBogus(int npoints, AlfAtom* alfatoms, real* bcoord, real* brad)
{
    if (npoints > 3) return;
