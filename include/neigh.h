...
QCMD_EXTERN double xvold;
QCMD_EXTERN double yvold;
QCMD_EXTERN double zvold;
QCMD_EXTERN double xeold;
QCMD_EXTERN double yeold;
QCMD_EXTERN double zeold;
QCMD_EXTERN double xuold;
QCMD_EXTERN double yuold;
QCMD_EXTERN double zuold;
