...
MDQC_EXTERN std::vector<double> acon;
MDQC_EXTERN std::vector<double> acon5;
MDQC_EXTERN std::vector<double> acon4;
MDQC_EXTERN std::vector<double> acon3;
MDQC_EXTERN std::vector<double> aconp;
MDQC_EXTERN std::vector<double> aconf;
MDQC_EXTERN std::vector<std::vector<double>> ang;
MDQC_EXTERN std::vector<std::vector<double>> ang5;
MDQC_EXTERN std::vector<std::vector<double>> ang4;
MDQC_EXTERN std::vector<std::vector<double>> ang3;
MDQC_EXTERN std::vector<std::vector<double>> angp;
MDQC_EXTERN std::vector<std::vector<double>> angf;
