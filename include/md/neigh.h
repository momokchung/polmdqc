...
MDQC_EXTERN double lbuffer,pbuffer;
MDQC_EXTERN double lbuf2,pbuf2;
MDQC_EXTERN double vbuf2,vbufx;
MDQC_EXTERN double dbuf2,dbufx;
MDQC_EXTERN double cbuf2,cbufx;
MDQC_EXTERN double mbuf2,mbufx;
MDQC_EXTERN double ubuf2,ubufx;
MDQC_EXTERN std::vector<double> xvold;
MDQC_EXTERN std::vector<double> yvold;
MDQC_EXTERN std::vector<double> zvold;
MDQC_EXTERN std::vector<double> xeold;
MDQC_EXTERN std::vector<double> yeold;
MDQC_EXTERN std::vector<double> zeold;
MDQC_EXTERN std::vector<double> xuold;
MDQC_EXTERN std::vector<double> yuold;
MDQC_EXTERN std::vector<double> zuold;
