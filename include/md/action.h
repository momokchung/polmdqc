...
/////////////////////////////////////////////////////////
//                                                     //
//  action  --  total number of each energy term type  //
//                                                     //
/////////////////////////////////////////////////////////
...
MDQC_EXTERN int neb,nea,neba,neub;
MDQC_EXTERN int neaa,neopb,neopd;
MDQC_EXTERN int neid,neit,net,nept;
MDQC_EXTERN int nebt,neat,nett,nev;
MDQC_EXTERN int ner,nedsp,nec,necd;
MDQC_EXTERN int ned,nem,nep,nect;
MDQC_EXTERN int news,nerxf,nes,nelf;
MDQC_EXTERN int neg,nex;
}
