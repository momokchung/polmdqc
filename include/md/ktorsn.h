...
MDQC_EXTERN std::vector<std::vector<double>> t1;
MDQC_EXTERN std::vector<std::vector<double>> t2;
MDQC_EXTERN std::vector<std::vector<double>> t3;
MDQC_EXTERN std::vector<std::vector<double>> t4;
MDQC_EXTERN std::vector<std::vector<double>> t5;
MDQC_EXTERN std::vector<std::vector<double>> t6;
MDQC_EXTERN std::vector<std::vector<double>> t15;
MDQC_EXTERN std::vector<std::vector<double>> t25;
MDQC_EXTERN std::vector<std::vector<double>> t35;
MDQC_EXTERN std::vector<std::vector<double>> t45;
MDQC_EXTERN std::vector<std::vector<double>> t55;
MDQC_EXTERN std::vector<std::vector<double>> t65;
MDQC_EXTERN std::vector<std::vector<double>> t14;
MDQC_EXTERN std::vector<std::vector<double>> t24;
MDQC_EXTERN std::vector<std::vector<double>> t34;
MDQC_EXTERN std::vector<std::vector<double>> t44;
MDQC_EXTERN std::vector<std::vector<double>> t54;
MDQC_EXTERN std::vector<std::vector<double>> t64;
