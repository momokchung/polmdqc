...
MDQC_EXTERN std::vector<double> dpl;
MDQC_EXTERN std::vector<double> dpl5;
MDQC_EXTERN std::vector<double> dpl4;
MDQC_EXTERN std::vector<double> dpl3;
MDQC_EXTERN std::vector<double> pos;
MDQC_EXTERN std::vector<double> pos5;
MDQC_EXTERN std::vector<double> pos4;
MDQC_EXTERN std::vector<double> pos3;
